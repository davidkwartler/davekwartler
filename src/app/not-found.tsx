...
export default function NotFound() {
  return (
    <>
      <SiteNav />
      <main id="main-content" tabIndex={-1} className="relative isolate flex min-h-svh flex-col items-center justify-center overflow-hidden bg-neutral-950 px-4 pt-16 text-center sm:px-6">
